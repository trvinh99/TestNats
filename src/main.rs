...
fn start_pipeline(root_path: String) -> Result<(), anyhow::Error> {
    ...
    let pipeline = gst::parse_launch(
        ...
        &format!("rtspsrc location=rtsp://10.50.13.252/1/h264major ! rtph264depay ! vaapih264dec ! videoconvert !  x264enc ! hlssink2 playlist-location={}/m3u8/hlstest.m3u8 location={}/hls/ch%05d.ts message-forward=true target-duration=6", root_path, root_path)
    )?;
